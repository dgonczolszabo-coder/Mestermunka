...
* __LICENSE létrehozása__
_GNU GENERAL PUBLIC LICENSE_ 

* __Konténerizáció Docker Composite konfigurációnak a hozzáadása szolgáltatásokhoz__
...
* __Responsive kliens oldali rész__
_Flex-col md:flex-row mobilokon egymás alá rakja a gombot  és az inputot viszont közepes méretű kijelzőn, rövidítve md egymás mellé. A kattintási felületek, azaz a padding a gombokon nagyobb._
